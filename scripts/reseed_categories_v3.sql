-- Reseed System Categories V3 (Ashkenazi Names & Full Parsha Mapping)

-- Clear existing data
DELETE FROM system_category_rules;
DELETE FROM system_categories;

-- Insert New Categories (Bereishis...Devorim, Jewish Holidays, Nach, etc.)
...
-- Insert Rules (Comprehensive Parsha Mapping)
...
('rule_vayetzei', 'cat_bereishis', 'Vayetzei', '["Vayetzei"]', 7, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_vaera', 'cat_shemos', 'Vaera', '["Vaera", "Va''era"]', 2, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_ki_tisa', 'cat_shemos', 'Ki Tisa', '["Ki Tisa"]', 9, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_nasso', 'cat_bamidbar', 'Nasso', '["Nasso"]', 2, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_behaalotcha', 'cat_bamidbar', 'Beha''alotcha', '["Beha''alotcha"]', 3, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_shlach', 'cat_bamidbar', 'Shlach', '["Shlach"]', 4, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
-- 5. Devorim Rules
INSERT INTO system_category_rules (id, category_id, name, keywords, "order", created_at, updated_at) VALUES
('rule_devarim', 'cat_devorim', 'Devorim', '["Devorim", "Devarim", "Deuteronomy"]', 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_vaetchanan', 'cat_devorim', 'Va''etchanan', '["Va''etchanan"]', 2, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_ki_teitzei', 'cat_devorim', 'Ki Teitzei', '["Ki Teitzei"]', 6, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_ki_tavo', 'cat_devorim', 'Ki Tavo', '["Ki Tavo"]', 7, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_tisha_bav', 'cat_holidays', 'Tisha B''Av', '["Tisha B''Av", "Three Weeks", "Fast"]', 9, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000);
...
('rule_proverbs', 'cat_nach', 'Proverbs', '["Proverbs", "Mishlei"]', 9, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_ecclesiastes', 'cat_nach', 'Ecclesiastes', '["Ecclesiastes", "Kohelet"]', 14, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
