-- Reseed System Categories V6 (Ashkenazi Names & Full Parsha Mapping - Comprehensive - Final)
...
-- Insert Rules (Comprehensive Parsha Mapping including ALL Ashkenazi variants)
...
('rule_miketz', 'cat_bereishis', 'Miketz', '["Miketz", "Mikeitz"]', 10, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_shemini', 'cat_vayikra', 'Shemini', '["Shemini", "Shmini"]', 3, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
-- 5. Devorim
INSERT INTO system_category_rules (id, category_id, name, keywords, "order", created_at, updated_at) VALUES
('rule_devorim', 'cat_devorim', 'Devorim', '["Devorim", "Devarim", "Dvorim", "Deuteronomy"]', 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_vzot_haberachah', 'cat_devorim', 'V''Zot HaBerachah', '["V''Zot HaBerachah", "Vezot Haberacha", "V''zos Habracha"]', 11, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000);

-- Holidays
INSERT INTO system_category_rules (id, category_id, name, keywords, "order", created_at, updated_at) VALUES
('rule_rosh_hashanah', 'cat_holidays', 'Rosh Hashanah', '["Rosh Hashanah", "Rosh Hashana"]', 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_yom_kippur', 'cat_holidays', 'Yom Kippur', '["Yom Kippur"]', 2, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
('rule_sukkot', 'cat_holidays', 'Sukkot', '["Sukkot", "Sukkos"]', 3, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
...
('rule_shavuot', 'cat_holidays', 'Shavuot', '["Shavuot", "Shavuos"]', 8, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000),
